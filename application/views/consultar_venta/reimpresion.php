                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            <div class="alert alert-success alert-dismissible">
                                ...
                                <i class="fa fa-info"></i>&nbsp; Los datos que se listan a continuacion son registros de la sucursal con la que inicio sesion.
                            </div>
                        </div>
                    </div>
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1" style="padding: 1%">
                                <table class="table table-bordered table-striped" id="lista_reimpresion_facturas">
                                    <thead>
                                    <tr>
